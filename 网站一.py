# -*- coding: utf-8 -*-
"""
网站一 - 私密网址中心 (Private Hub)
===================================
集启动页、文件服务器、笔记系统、仪表盘于一体的私密网站
...
环境变量：
    HUB_PASSWORD  - 登录密码（不设置则自动生成）
    HUB_PORT      - 端口号（默认8888）
    
公网访问：
    安装后运行: pip install flask psutil
    启动服务: python 网站一.py
    新终端运行: ngrok http 8888 或 cloudflared tunnel --url localhost:8888
"""
...
if __name__ == "__main__":
    port = int(os.environ.get("HUB_PORT", 8888))
    
    print(f"""
╔═══════════════════════════════════════════════════════╗
║           🔐 私密中心 (Private Hub)                   ║
╠═══════════════════════════════════════════════════════╣
║  功能: 启动页 | 文件管理 | 笔记系统 | 仪表盘          ║
║                                                       ║
║  本地访问: http://localhost:{port}                      ║
║                                                       ║
║  公网访问（任选其一）:                                 ║
║    1. ngrok:      ngrok http {port}                    ║
║    2. cloudflare: cloudflared tunnel --url localhost:{port}║
║    3. 部署云平台: Railway / Render / Vercel            ║
╚═══════════════════════════════════════════════════════╝
    """)
    load_config()
