    ...
    <div class="main-layout">
        ...
        <div class="container">
            ...
            <div class="grid">
                ...
                <div class="card"><h3>💾 磁盘</h3><div id="disk-info">加载中...</div></div>
                <div class="card"><h3>ℹ️ 系统</h3><div id="sys-info">加载中...</div></div>
                <div class="card chart-card"><h3>📊 系统监控</h3><canvas id="usageChart" height="120"></canvas></div>
                <div class="card"><h3>📋 操作日志</h3><div class="log-box" id="log-box"><div class="log-entry"><span class="log-time">--:--</span>系统启动</div></div></div>
            </div>
        </div>
    </div>
